...
- Name: features/patients/patient.e2e.ts >> Patient page — filter bar >> ward filter works independently of status filter
- Location: src/features/patients/patient.e2e.ts:60:3
