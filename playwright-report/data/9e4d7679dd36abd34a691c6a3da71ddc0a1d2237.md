...
- Name: features/patients/patient.e2e.ts >> Patient page — filter bar >> Clear button appears when filters are active and clears them
- Location: src/features/patients/patient.e2e.ts:48:3
